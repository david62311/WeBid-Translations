...
<table border="0" width="100%">
	<tr>
		<td colspan="2" height="35"><div style="font-size: 14px; font-weight: bold;">Alguien quiere que veas una subasta en {SITENAME}!</div></td>
	</tr>
	<tr>
		<td colspan="2" style="font-size: 12px;">Hola <b>{F_NAME}</b>,</td>
	</tr>
	<tr>
		<td colspan="2" height="50" style="font-size: 12px; padding-right: 6px;">
		 Te ha sido transmitido una subasta desde {S_NAME} (<a href="mailto:{S_EMAIL}">{S_EMAIL}</a>) en {SITENAME}
		</td>
	</tr>
	<tr>
		<td width="55%" rowspan="2" valign="top" style="font-size: 12px; line-height: 0.6cm;">
            <b>Título Subasta:</b> 	{TITLE} <br />
            <b>Comentarios:</b> {S_COMMENT}<br />
		</td>
		<td width="34%" style="font-size: 12px;">Comprobar la Subasta!</td>
	</tr>
	<tr>
