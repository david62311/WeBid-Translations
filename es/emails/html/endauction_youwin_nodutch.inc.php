...
<table border="0" width="100%">
	<tr>
		<td colspan="3" height="35"><div style="font-size: 14px; font-weight: bold;">Felicidades, ganaste el artículo!</div></td>
	</tr>
	<tr>
		<td colspan="3" style="font-size: 12px;">Hola <b>{W_NAME}</b>,</td>
	</tr>
	<tr>
		<td colspan="3" height="50" style="font-size: 12px; padding-right: 6px;"><i>Felicidades</i> te comprometiste a comprar el siguiente artículo:</td>
	</tr>
	<tr>
		...
		<table border="0" width="100%">
			...
			<tr>
				<td width="18%" style="font-size: 12px;">Tu puja:</td>
...
<table border="0" width="100%">
	<tr>
		<td style="font-size: 12px;"><b>Información del Vendedor</b></td>
	</tr>
	<tr>
