...
<table border="0" width="100%">
	<tr>
		<td colspan="3" height="35"><div style="font-size: 14px; font-weight: bold;">Tu subasta ha finalizado sin ganador en {SITENAME}</div></td>
	</tr>
	<tr>
	...
	<tr>
		...
		Lo sentimos, la subasta que creaste en {SITENAME} ha finalizado sin ganador</td>
	</tr>
	<tr>
		...
		<table border="0" width="100%">
			...
			<tr>
				<td width="22%" style="font-size: 12px;">URL subasta:</td>
